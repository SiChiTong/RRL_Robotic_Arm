...
void ArmStructure::CreateChain(const std::string& name,unsigned int min,unsigned int max)
{
...
//
void ArmStructure::buildChildren(const std::string& name)
{
...
std::vector<gazebo::physics::JointPtr> ArmStructure::GetJoints(const std::string& name)
{
...
std::vector<gazebo::math::Vector3> ArmStructure::GetAxis(const std::string& name)
{
  std::vector<gazebo::physics::JointPtr> joints = this->chains[name];
...
std::vector<gazebo::math::Pose> ArmStructure::GetPoses(const std::string& name)
{
  std::vector<gazebo::physics::JointPtr> joints = this->chains[name];
...
std::vector<std::vector<double>> ArmStructure::GetRelativeLimits(const std::string& name, bool fixFingers)
{
  std::vector<gazebo::physics::JointPtr> joints = this->chains[name];
...
std::vector<std::vector<double>> ArmStructure::GetLimits(const std::string& name)
{
  std::vector<gazebo::physics::JointPtr> joints = this->chains[name];
  std::vector<std::vector<double>> limits;
  unsigned int i = 0;
...
std::vector<std::vector<unsigned int>> ArmStructure::GetChildren(const std::string& name)
{
  return this->chainsChildren[name];
}

std::vector<unsigned int> ArmStructure::GetRanks(const std::string& name)
{
  std::vector<gazebo::physics::JointPtr> joints = this->chains[name];
...
std::vector<gazebo::math::Vector3> ArmStructure::GetMovedSingleTarget(const std::string& name, const gazebo::math::Vector3& scale)
{
...
std::vector<gazebo::math::Vector3> ArmStructure::GetNaturalSingleEndEffectors(const std::string& name)
{
  gazebo::physics::JointPtr joint = this->chains[name].back();
