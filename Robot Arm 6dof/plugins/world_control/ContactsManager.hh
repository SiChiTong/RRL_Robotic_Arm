...
class ContactsManager
{
  ...
  public:
    ...
    ContactsManager();
    ~ContactsManager();
    void Init(gazebo::physics::ContactManager* contactManager, const std::string& worldName, unsigned int freq);
    bool checkCollisions(bool touch);
};
#endif
